...
(function (t, n) {
  ...
  function h(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= Hs ? 10 : o >= js ? 5 : o >= Xs ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= Hs ? 10 : o >= js ? 5 : o >= Xs ? 2 : 1);
  }
  function p(t, n, e) {
      ...
      (b = b.merge(
        ...
        (S = S.merge(
          N.append("text")
            .attr("fill", "#000")
            .attr(f, s * d)
            .attr("dy", t === $s ? "0em" : t === Zs ? "0.71em" : "0.32em")
        )),
        e !== m &&
          ((b = b.transition(e)),
          (w = w.transition(e)),
        ...
        b.attr(
          "d",
          t === Gs || t == Ws
            ? "M" + s * a + "," + g + "H0.5V" + _ + "H" + s * a
            : "M" + g + "," + s * a + "V0.5H" + _ + "V" + s * a
        ),
    ...
    return (
      ...
      (e.tickArguments = function (t) {
        return arguments.length
          ? ((r = null == t ? [] : Vs.call(t)), e)
          : r.slice();
      }),
      (e.tickValues = function (t) {
        return arguments.length
          ? ((i = null == t ? null : Vs.call(t)), e)
          : i && i.slice();
      }),
  ...
  function E(t) {
    ...
    return (
      ...
      tf.hasOwnProperty(n) ? { space: tf[n], local: t } : t
    );
  }
  function A(t) {
    var n = E(t);
        ...
        : function (t) {
            return function () {
              var n = this.ownerDocument,
                e = this.namespaceURI;
              return e === Ks && n.documentElement.namespaceURI === Ks
                ? n.createElement(t)
  ...
  function U(t, n, e, r, i, o, u) {
    ...
    for (a = 0; a < l; ++a)
      (c = n[a]) &&
        ((p[a] = s = uf + u.call(c, c.__data__, a, n)),
        s in f ? (i[a] = c) : (f[s] = c));
    for (a = 0; a < h; ++a)
      (c = f[(s = uf + u.call(t, o[a], a, o))])
  ...
  function I(t, n) {
    return (
      ...
      F(t).getComputedStyle(t, null).getPropertyValue(n)
    );
  }
  function Y(t) {
  ...
  function Et(t) {
    ...
    return (
      ...
      (n = pf.exec(t))
        ...
        ? Ct(n[1], n[2], n[3], n[4])
        : (n = yf.exec(t))
        ? Ct((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
        : (n = mf.exec(t))
  ...
  function Ot(t) {
    ...
    var e = jt(t.r),
      r = jt(t.g),
      i = jt(t.b),
      o = Yt((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / Tf),
      u = Yt((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Nf);
    return new It(
      116 * u - 16,
      500 * (o - u),
      200 * (u - Yt((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / kf)),
      t.opacity
    );
  }
  function Ft(t, n, e, r) {
        ...
        (function (t, n, e, o) {
          t !== n
            ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
              o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: an(t, n) }))
            : n && e.push(i(e) + "rotate(" + n + r);
        })(o.rotate, u.rotate, a, c),
        (function (t, n, e, o) {
          t !== n
            ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: an(t, n) })
  ...
  function kn(t) {
    if (!cl) {
      ...
      t - pl > 24
        ? (t < 1 / 0 && (sl = setTimeout(Tn, t - vl.now() - dl)),
          fl && (fl = clearInterval(fl)))
        : (fl || ((hl = vl.now()), (fl = setInterval(Nn, ll))),
          (cl = 1),
          gl(Tn));
    }
  }
          ...
          if ((h = a[s]).name === e.name) {
            ...
            h.state === Ml
              ? ((h.state = Nl),
                ...
                delete a[s])
              : +s < n && ((h.state = Nl), h.timer.stop(), delete a[s]);
          }
        if (
          (Sn(function () {
            e.state === wl &&
              ((e.state = Ml), e.timer.restart(i, e.delay, e.time), i(c));
          }),
          (e.state = bl),
          ...
          for (
            e.state = wl, u = new Array((l = e.tween.length)), s = 0, f = -1;
            s < l;
            ++s
          )
        ...
        for (
          var r =
              n < e.duration
                ...
                : (e.timer.restart(o), (e.state = Tl), 1),
            i = -1,
            a = u.length;
          ++i < a;
    ...
    function u() {
      function e() {
        ...
        !L ||
          x ||
          b ||
          (Math.abs(t[0] - D[0]) > Math.abs(t[1] - D[1]) ? (b = !0) : (x = !0)),
          (D = t),
          (m = !0),
          $n(),
          o();
      ...
      function o() {
        ...
        switch (((_ = D[0] - q[0]), (y = D[1] - q[1]), T)) {
          ...
          case Kl:
            N &&
              ((_ = Math.max(C - a, Math.min(P - p, _))),
              (s = a + _),
              (d = p + _)),
              k &&
                ((y = Math.max(z - l, Math.min(R - v, y))),
                (h = l + y),
                (g = v + y));
            break;
          case nh:
            N < 0
              ? ((_ = Math.max(C - a, Math.min(P - a, _))),
                (s = a + _),
                (d = p))
              : N > 0 &&
                ((_ = Math.max(C - p, Math.min(P - p, _))),
                (s = a),
                (d = p + _)),
              k < 0
                ? ((y = Math.max(z - l, Math.min(R - l, y))),
                  (h = l + y),
                  (g = v))
                : k > 0 &&
                  ((y = Math.max(z - v, Math.min(R - v, y))),
                  (h = l),
                  (g = v + y));
            break;
          case eh:
            N &&
              ((s = Math.max(C, Math.min(P, a - _ * N))),
              (d = Math.max(C, Math.min(P, p + _ * N)))),
              k &&
                ((h = Math.max(z, Math.min(R, l - y * k))),
        ...
        d < s &&
          ...
          x && ((s = A[0][0]), (d = A[1][0])),
          b && ((h = A[0][1]), (g = A[1][1])),
          (A[0][0] === s && A[0][1] === h && A[1][0] === d && A[1][1] === g) ||
            ((S.selection = [
              [s, h],
              [d, g],
            ]),
      ...
      if (f.apply(this, arguments)) {
        ...
        "overlay" === M
          ...
          : ((a = A[0][0]), (l = A[0][1]), (p = A[1][0]), (v = A[1][1])),
          (s = a),
          (h = l),
          (d = p),
          (g = v);
    ...
    function n(t, n) {
      function e() {
        ...
        if (t.charCodeAt(r) === Th) {
          for (
            ;
            (a++ < u && t.charCodeAt(a) !== Th) || t.charCodeAt(++a) === Th;
      ...
      var r,
        ...
        f = !1;
      for (
        t.charCodeAt(u - 1) === Nh && --u, t.charCodeAt(u - 1) === kh && --u;
        (r = e()) !== Mh;
    ...
    function n(t) {
      function n(t) {
        ...
        switch (
          (p &&
            l &&
            ((t = e(M + t, M.length ? h - x.length : 1 / 0)), (M = "")),
          c)
        ) {
          case "<":
            t = f + t + x + M;
  ...
  function Be(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Le(n) / 3))) - Le(Math.abs(t))
    );
  }
  function He(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Le(n) - Le(t)) + 1
    );
  }
  function je() {
    return new Xe();
  ...
  function pr(t, n) {
    ...
    if (rp) {
      ...
      s ^ (a * tp < c && c < a * t)
        ...
        s
          ? t < tp
            ? mr(Gh, t) > mr(Gh, Jh) && (Jh = t)
            : mr(t, Jh) > mr(Gh, Jh) && (Gh = t)
          : Jh >= Gh
          ? (t < Gh && (Gh = t), t > Jh && (Jh = t))
          : t > tp
          ? mr(Gh, t) > mr(Gh, Jh) && (Jh = t)
  ...
  function Fr(t) {
    ...
    return (
      (t = qr(t[0] * Cp, t[1] * Cp, t.length > 2 ? t[2] * Cp : 0)),
      (n.invert = function (n) {
        return (
          (n = t.invert(n[0] * Cp, n[1] * Cp)), (n[0] *= Ap), (n[1] *= Ap), n
        );
      }),
      n
    );
        ...
        if ((d.pop(), h.push(d), (d = null), a))
          if (1 & o) {
            if (((e = u[0]), (n = e.length - 1) > 0)) {
              for (
                m || (i.polygonStart(), (m = !0)), i.lineStart(), t = 0;
                t < n;
                ++t
              )
                i.point((r = e[t])[0], r[1]);
      ...
      var h,
        ...
        x = {
          ...
          polygonEnd: function () {
            ...
            var t = $r(h, r);
            p.length
              ? (m || (i.polygonStart(), (m = !0)), Xr(p, Gr, t, e, i))
              : t &&
                (m || (i.polygonStart(), (m = !0)),
                i.lineStart(),
                e(null, null, 1, i),
                i.lineEnd()),
              m && (i.polygonEnd(), (m = !1)),
  ...
  function Gr(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - kp - Mp : kp - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - kp - Mp : kp - n[1])
    );
  }
  function Qr(t) {
    function n(t, n) {
        ...
        return {
          ...
          point: function (l, h) {
            ...
            if (
              (!i && (s = c = v) && t.lineStart(),
              v !== c &&
                (!(p = e(i, d)) || Hr(i, p) || Hr(d, p)) &&
                ((d[0] += Mp), (d[1] += Mp), (v = n(d[0], d[1]))),
              v !== c)
            )
              (f = 0),
                v
                  ? (t.lineStart(), (p = e(d, i)), t.point(p[0], p[1]))
                  : ((p = e(i, d)), t.point(p[0], p[1]), t.lineEnd()),
                (i = p);
            else if (a && i && u ^ v) {
              var _;
              g & o ||
    ...
    return function (u) {
      ...
      function s(o, u) {
        ...
        if ((l && h.push([o, u]), x))
          ...
          var c = [
              (_ = Math.max(ld, Math.min(fd, _))),
              (y = Math.max(ld, Math.min(fd, y))),
            ],
            s = [
              (o = Math.max(ld, Math.min(fd, o))),
              (u = Math.max(ld, Math.min(fd, u))),
            ];
          !(function (t, n, e, r, i, o) {
            ...
            ? a && (w.lineStart(), w.point(o, u), (b = !1))
            : (m || (w.lineStart(), w.point(c[0], c[1])),
              w.point(s[0], s[1]),
              a || w.lineEnd(),
              (b = !1));
        }
  ...
  function hi() {
    ...
    function n() {
      return f(qp(o / _) * _, i, _)
        .map(p)
        .concat(f(qp(s / y) * y, c, y).map(d))
        .concat(
          f(qp(r / v) * v, e, v)
            .filter(function (t) {
              return zp(t % _) > Mp;
          ...
          function e(r, i, o, u, a, c, s, f, l, h, p, d, v, g) {
            ...
            if (m > 4 * n && v--) {
              var x = u + h,
                ...
                T = We((w /= M)),
                N =
                  zp(zp(w) - 1) < Mp || zp(o - l) < Mp ? (o + l) / 2 : Rp(b, x),
                k = t(N, T),
                S = k[0],
                E = k[1],
                A = S - r,
                ...
                z = y * A - _ * C;
              ((z * z) / m > n ||
                zp((_ * A + y * C) / m - 0.5) > 0.3 ||
                u * h + a * p + c * d < jd) &&
                (e(r, i, o, u, a, c, S, E, N, (x /= M), (b /= M), w, v, g),
                g.point(S, E),
  ...
  function ko(t) {
    ...
    t: for (a = 3; a < i; ++a) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = To(n);
        (r = r.next) !== e;
  ...
  function Xo(t, n, e, r, i, o) {
    for (
      ...
      _.push((u = { value: f, dice: c < s, children: y.slice(m, x) })),
        u.dice
          ? qo(u, e, r, i, w ? (r += (s * f) / w) : o)
          : jo(u, e, r, w ? (e += (c * f) / w) : i, o),
        (w -= f),
        (m = x);
    }
    return _;
              ...
              return function (e, r) {
                t._tasks[n] &&
                  ...
                  null == t._error &&
                    (null != e
                      ? Qo(t, e)
                      : ((t._data[n] = r), t._waiting ? Go(t) : Jo(t))));
              };
            })(t, n)),
              --t._waiting,
              ++t._active,
  ...
  function pu(t, n) {
    function e() {
      return (
        (i = Math.min(a.length, c.length) > 2 ? lu : fu), (o = u = null), r
      );
    }
    function r(n) {
      return (
      ...
      (n.tickFormat = function (n, r) {
        return (function (n, e, r) {
          ...
          switch ((r = De(null == r ? ",f" : r)).type) {
            ...
            case "r":
              null != r.precision ||
                isNaN((i = He(a, Math.max(Math.abs(o), Math.abs(u))))) ||
  ...
  function Tu() {
    function n() {
      return (
        (o = wu(i)), (u = bu(i)), r()[0] < 0 && ((o = Mu(o)), (u = Mu(u))), e
      );
    }
  ...
  function Au() {
    ...
    return (
      (t.domain = function (i) {
        return arguments.length
          ? ((n = _v.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : n.slice();
      }),
      (t.range = function (i) {
        return arguments.length
          ? ((e = _v.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : e.slice();
      }),
      (t.invertExtent = function (t) {
        var r = e.indexOf(t);
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            xv.setTime(+n), bv.setTime(+r), t(xv), t(bv), Math.floor(e(xv, bv))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  function zu(t) {
    return Cu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Tv) / Nv
        );
      }
    );
  }
  ...
  function Du(t) {
    ...
    function e(t, n) {
      return function (e) {
        ...
        return "Z" in u
          ? ((u.H += (u.Z / 100) | 0), (u.M += u.Z % 100), Lu(u))
          : n(u);
      };
    }
    function r(t, n, e, r) {
    ...
    function l(n, r, i, o) {
      if ((null == n && (n = 10), "number" == typeof n)) {
        ...
        a === T.length
          ? ((o = p(r / Dg, i / Dg, n)), (n = t))
          : a
          ? ((o = (a = T[u / T[a - 1][2] < T[a][2] / u ? a - 1 : a])[1]),
            (n = a[0]))
          : ((o = Math.max(p(r, i, n), 1)), (n = c));
      }
  ...
  function cc() {
    ...
    return (
      (t.x = function (e) {
        return arguments.length
          ? ((n = "function" == typeof e ? e : Ga(+e)), t)
          : n;
      }),
      (t.y = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : Ga(+n)), t)
          : e;
      }),
      (t.defined = function (n) {
        return arguments.length
          ? ((r = "function" == typeof n ? n : Ga(!!n)), t)
          : r;
      }),
      (t.curve = function (n) {
  ...
  function sc() {
    ...
    return (
      (t.x = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : Ga(+n)), (r = null), t)
          : e;
      }),
      (t.x0 = function (n) {
        return arguments.length
      ...
      (t.x1 = function (n) {
        return arguments.length
          ? ((r = null == n ? null : "function" == typeof n ? n : Ga(+n)), t)
          : r;
      }),
      (t.y = function (n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : Ga(+n)), (o = null), t)
          : i;
      }),
      (t.y0 = function (n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : Ga(+n)), t)
          : i;
      }),
      (t.y1 = function (n) {
        return arguments.length
          ? ((o = null == n ? null : "function" == typeof n ? n : Ga(+n)), t)
          : o;
      }),
      (t.lineX0 = t.lineY0 =
        function () {
  ...
  function xc(t) {
    function n() {
      ...
      if (
        ...
        t(
          u,
          +i.apply(this, ((a[0] = c), a)),
          +o.apply(this, a),
          +i.apply(this, ((a[0] = s), a)),
          +o.apply(this, a)
        ),
        n)
      )
    ...
    return (
      ...
      (n.x = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : Ga(+t)), n)
          : i;
      }),
      (n.y = function (t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : Ga(+t)), n)
          : o;
      }),
  ...
  function Ic(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      a = (o * i + u * r) / (r + i);
    return (
      (Fc(o) + Fc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) ||
      0
    );
  }
  function Yc(t, n) {
  ...
  function _s(t) {
    var n = t.circle;
    n &&
      (n.P || (P_ = n.N), q_.remove(n), U_.push(n), is(n), (t.circle = null));
  }
  function ys(t) {
    var n =
      O_.pop() ||
  ...
  function xs(t) {
    ...
    for (
      var c = o;
      c.circle &&
      Math.abs(e - c.circle.x) < F_ &&
      Math.abs(r - c.circle.cy) < F_;
    ...
    for (
      var s = u;
      s.circle &&
      Math.abs(e - s.circle.x) < F_ &&
      Math.abs(r - s.circle.cy) < F_;
    ...
    if (
      ...
      (function (t, n, e, r) {
        for (var i, o = D_.length; o--; )
          (hs((i = D_[o]), t, n, e, r) &&
            ls(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > F_ ||
              Math.abs(i[0][1] - i[1][1]) > F_)) ||
            delete D_[o];
      })(u, a, c, s),
        (function (t, n, e, r) {
          var i,
            ...
            if ((o = L_[i])) {
              ...
              for (a = 0, s = c.length; a < s; )
                (d = (p = vs(o, D_[c[a]]))[0]),
                  ...
                  (l = (f = ds(o, D_[c[++a % s]]))[0]),
                  (h = f[1]),
                  (Math.abs(d - l) > F_ || Math.abs(v - h) > F_) &&
                    (c.splice(
                      a,
                      0,
                      D_.push(
                        ss(
                          u,
                          p,
                          Math.abs(d - t) < F_ && r - v > F_
                            ? [t, Math.abs(l - t) < F_ ? h : r]
                            : Math.abs(v - r) < F_ && e - d > F_
                            ? [Math.abs(h - r) < F_ ? l : e, r]
                            : Math.abs(d - e) < F_ && v - n > F_
                            ? [e, Math.abs(l - e) < F_ ? h : n]
                            : Math.abs(v - n) < F_ && d - t > F_
                            ? [Math.abs(h - n) < F_ ? l : t, n]
                            : null
                        )
                      ) - 1
                    ),
          ...
          if (_) {
            ...
            for (i = 0, _ = null; i < g; ++i)
              (o = L_[i]) &&
                (x = (y = (u = o.site)[0] - t) * y + (m = u[1] - n) * m) < b &&
                ((b = x), (_ = o));
            if (_) {
              var w = [t, n],
                M = [t, r],
  ...
  if ("undefined" != typeof document) {
    ...
    if (!ef.matches) {
      var rf =
        ef.webkitMatchesSelector ||
        ef.msMatchesSelector ||
        ef.mozMatchesSelector ||
        ef.oMatchesSelector;
      nf = function (t) {
        return function () {
  ...
  if (((t.event = null), "undefined" != typeof document)) {
    "onmouseenter" in document.documentElement ||
      (af = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }
  var cf = [null];
    ...
    kt(St, {
      ...
      rgb: function () {
        ...
        return (
          ...
          (e = kf * Bt(e)),
          new Rt(
            Ht(3.2404542 * n - 1.5371385 * t - 0.4985314 * e),
            Ht(-0.969266 * n + 1.8760108 * t + 0.041556 * e),
            Ht(0.0556434 * n - 0.2040259 * t + 1.0572252 * e),
            this.opacity
          )
        );
      },
      ...
      function (t) {
        return "none" === t
          ...
          : (Uf ||
            ...
            (t = Ff.getComputedStyle(Of.appendChild(Uf), null).getPropertyValue(
              "transform"
            )),
            Of.removeChild(Uf),
            (t = t.slice(7, -1).split(",")),
      ...
      function (t) {
        return null == t
          ...
          : (If ||
            ...
            (t = If.transform.baseVal.consolidate())
  ...
  qn.prototype = Dn.prototype = {
              ...
              ? function (t, n, e) {
                  ...
                  return function () {
                    var u,
                      a = e(this);
                    if (null != a)
                      return (u = this.getAttributeNS(t.space, t.local)) === a
                        ? null
                        : u === r && a === i
                        ? o
                        : (o = n((r = u), (i = a)));
              ...
              : function (t, n, e) {
                  ...
                  return function () {
                    var u,
                      a = e(this);
                    if (null != a)
                      return (u = this.getAttribute(t)) === a
                        ? null
                        : u === r && a === i
                        ? o
                        : (o = n((r = u), (i = a)));
            ...
            "function" == typeof n
              ? (function (t, n, e) {
                  ...
                  return function () {
                    ...
                    return (
                      null == a &&
                        (this.style.removeProperty(t), (a = I(this, t))),
                      u === a
                        ? null
                        : u === r && a === i
                        ? o
    ...
    tween: function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = zn(this.node(), e).tween, o = 0, u = i.length;
          o < u;
          ++o
        )
  ...
  var Al = (function t(n) {
    ...
    Ql = { time: null, delay: 0, duration: 250, ease: Fn };
  (at.prototype.interrupt = function (t) {
    ...
    (at.prototype.transition = function (t) {
      ...
      t instanceof qn
        ? ((n = t._id), (t = t._name))
        : ((n = Un()), ((e = Ql).time = mn()), (t = null == t ? null : t + ""));
  ...
  (Uh.copy = function () {
    ...
    (Uh.visit = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && a.push(new be(c, this._x0, this._y0, this._x1, this._y1));
        (n = a.pop());
  ...
  var Oh,
    ...
    Yh = {
      "": function (t, n) {
        t: for (
          var e, r = (t = t.toPrecision(n)).length, i = 1, o = -1;
          i < r;
          ++i
        )
          switch (t[i]) {
  ...
  Ie({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }),
    (Xe.prototype = {
      constructor: Xe,
      reset: function () {
        this.s = this.t = 0;
  ...
  var Qp,
    ...
    dd = [null, null],
    vd = { type: "LineString", coordinates: dd },
    gd = {
      Feature: function (t, n) {
      ...
      function e(t, e, r, i, o) {
        if ((u = t._squarify) && u.ratio === n)
          for (
            ...
            for (
              c = (a = u[l]).children, s = a.value = 0, f = c.length;
              s < f;
              ++s
            )
              a.value += c[s].value;
            a.dice
              ? qo(a, e, r, i, (r += ((o - r) * a.value) / p))
              : jo(a, e, r, (e += ((i - e) * a.value) / p), o),
              (p -= a.value);
          }
  ...
  var Mv = wv.range,
    ...
    Pv = Cu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Tv) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  var Sg = "%Y-%m-%dT%H:%M:%S.%LZ",
    ...
    Yg = al($t(300, 0.5, 0), $t(-240, 0.5, 1)),
    Bg = al($t(-100, 0.75, 0.35), $t(80, 1.5, 0.8)),
    Hg = al($t(260, 0.75, 0.35), $t(80, 1.5, 0.8)),
    jg = $t(),
    Xg = Wa(
      $a(
    ...
    M_ = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          ...
          t.lineTo(-0.5 * o - x_ * u, x_ * o + -0.5 * u),
          t.lineTo(-0.5 * a - x_ * c, x_ * a + -0.5 * c),
          t.lineTo(-0.5 * r + x_ * i, -0.5 * i - x_ * r),
          t.lineTo(-0.5 * o + x_ * u, -0.5 * u - x_ * o),
      ...
      insert: function (t, n) {
        ...
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (os(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                us(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (us(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              os(this, r)),
            (e = t.U);
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C &&
                    ((n.C = !1), (i.C = !0), os(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) ||
                    ((n.L.C = !1), (n.C = !0), us(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    os(this, i),
                    (t = this._);
                ...
                ((n = i.L).C &&
                  ((n.C = !1), (i.C = !0), us(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) ||
                  ((n.R.C = !1), (n.C = !0), os(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  us(this, i),
                  (t = this._);
  ...
  (Ns.prototype = {
    ...
    (Ss.prototype = {
      ...
      translate: function (t, n) {
        return (0 === t) & (0 === n)
          ? this
          : new Ss(this.k, this.x + this.k * t, this.y + this.k * n);
      },
      apply: function (t) {
  ...
  (Es.prototype = Ss.prototype),
    ...
    (t.histogram = function () {
      ...
      return (
        (t.value = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : c(e)), t)
            : n;
        }),
        (t.domain = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : c([n[0], n[1]])), t)
            : e;
        }),
    ...
    (t.chord = function () {
      function t(t) {
        ...
        for (
          ...
          (_[m] = { index: m, startAngle: a, endAngle: u, value: p[m] }),
            (u += c);
        }
        for (s = -1; ++s < h; )
          for (l = s - 1; ++l < h; ) {
    ...
    (t.ribbon = function () {
      function t() {
        ...
        if (
          ...
          u.arc(0, 0, f, l, h),
          (l === g && h === _) ||
            (u.quadraticCurveTo(0, 0, v * lh(g), v * hh(g)),
            u.arc(0, 0, v, g, _)),
      ...
      return (
        (t.radius = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : te(+n)), t)
            : r;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : te(+n)), t)
            : i;
        }),
        (t.endAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : te(+n)), t)
            : o;
        }),
        (t.source = function (e) {
    ...
    (t.nest = function () {
      function t(n, i, u, a) {
        ...
        for (
          var c, s, f, l = -1, h = n.length, p = o[i++], d = se(), v = u();
          ++l < h;
    ...
    (t.drag = function () {
      ...
      function o() {
        if (p.apply(this, arguments)) {
          var n,
            ...
            o = r.length;
          for (n = 0; n < o; ++n)
            (e = c(r[n].identifier, i, dt, this, arguments)) &&
              (vt(), e("start"));
        }
      }
      function u() {
      ...
      function c(e, r, i, o, u) {
        ...
        if (
          it(
            new xt(n, "beforestart", a, e, m, f[0], f[1], 0, 0, l),
            function () {
              return (
                null != (t.event.subject = a = v.apply(o, u)) &&
    ...
    (t.forceCollide = function (t) {
      ...
      var i,
        ...
        a = 1;
      return (
        "function" != typeof t && (t = ye(null == t ? 1 : +t)),
        ...
        (n.radius = function (e) {
          return arguments.length
            ? ((t = "function" == typeof e ? e : ye(+e)), r(), n)
            : t;
        }),
        n
      );
    ...
    (t.forceLink = function (t) {
        ...
        for (var e = 0, r = t.length; e < p; ++e)
          for (var i, a, c, f, l, h, d, v = 0; v < r; ++v)
            (a = (i = t[v]).source),
              ...
              (f *= h =
                (((h = Math.sqrt(f * f + l * l)) - u[v]) / h) * n * o[v]),
              (l *= h),
              (c.vx -= f * (d = s[v])),
              (c.vy -= l * d),
              (a.vx += f * (d = 1 - d)),
      ...
      function e() {
        if (a) {
          ...
          for (n = 0, s = new Array(h); n < h; ++n)
            (e = t[n]),
              (s[n] =
                c[e.source.index] / (c[e.source.index] + c[e.target.index]));
      ...
      return (
        ...
        (n.strength = function (t) {
          return arguments.length
            ? ((l = "function" == typeof t ? t : ye(+t)), r(), n)
            : l;
        }),
        (n.distance = function (t) {
          return arguments.length
            ? ((h = "function" == typeof t ? t : ye(+t)), i(), n)
            : h;
        }),
        n
      );
    ...
    (t.forceManyBody = function () {
      ...
      return (
        ...
        (t.strength = function (e) {
          return arguments.length
            ? ((c = "function" == typeof e ? e : ye(+e)), n(), t)
            : c;
        }),
    ...
    (t.forceRadial = function (t, n, e) {
      ...
      return (
        ...
        (r.strength = function (t) {
          return arguments.length
            ? ((c = "function" == typeof t ? t : ye(+t)), i(), r)
            : c;
        }),
        (r.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : ye(+n)), i(), r)
            : t;
        }),
        (r.x = function (t) {
    ...
    (t.forceX = function (t) {
      ...
      var r,
        ...
        u = ye(0.1);
      return (
        "function" != typeof t && (t = ye(null == t ? 0 : +t)),
        (n.initialize = function (t) {
          (r = t), e();
        }),
        (n.strength = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : ye(+t)), e(), n)
            : u;
        }),
        (n.x = function (r) {
          return arguments.length
            ? ((t = "function" == typeof r ? r : ye(+r)), e(), n)
            : t;
        }),
        n
      );
    ...
    (t.geoBounds = function (t) {
      var n, e, r, i, o, u, a;
      if (
        ((Kh = Jh = -(Gh = Qh = 1 / 0)), (ip = []), tr(t, Zp), (e = ip.length))
      ) {
        for (ip.sort(xr), n = 1, o = [(r = ip[0])]; n < e; ++n)
          br(r, (i = ip[n])[0]) || br(r, i[1])
            ? (mr(r[0], i[1]) > mr(r[0], r[1]) && (r[1] = i[1]),
              mr(i[0], r[1]) > mr(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
    ...
    (t.geoCentroid = function (t) {
      ...
      return i < Tp &&
        ...
        (e = hp),
        (r = pp),
        ap < Mp && ((n = cp), (e = sp), (r = fp)),
        (i = n * n + e * e + r * r) < Tp)
        ? [NaN, NaN]
        : [Rp(e, n) * Ap, We(r / Yp(i)) * Ap];
    }),
    (t.geoCircle = function () {
      ...
      return (
        (t.center = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : Pr([+n[0], +n[1]])), t)
            : r;
        }),
        (t.radius = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : Pr(+n)), t)
            : i;
        }),
        (t.precision = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : Pr(+n)), t)
            : o;
        }),
        t
      );
    ...
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (e.projection = function (n) {
          return arguments.length
            ? ((r = null == n ? ((t = null), pi) : (t = n).stream), e)
            : t;
        }),
        (e.context = function (t) {
          return arguments.length
            ? ((i = null == t ? ((n = null), new Ci()) : new Si((n = t))),
        ...
        (t.translate = function (t) {
          ...
          return (
            ...
            (o = s
              ...
              .clipExtent([
                [r - 0.425 * e + Mp, a + 0.12 * e + Mp],
                [r - 0.214 * e - Mp, a + 0.234 * e - Mp],
              ])
              .stream(l)),
            (u = f
              .translate([r - 0.205 * e, a + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + Mp, a + 0.166 * e + Mp],
                [r - 0.115 * e - Mp, a + 0.234 * e - Mp],
              ])
              .stream(l)),
            n()
          );
    ...
    (t.geoIdentity = function () {
      ...
      return (u = {
        ...
        scale: function (n) {
          return arguments.length
            ? ((h = no((a = +n) * f, a * l, c, s)), t())
            : a;
        },
        translate: function (n) {
          return arguments.length
            ? ((h = no(a * f, a * l, (c = +n[0]), (s = +n[1]))), t())
            : [c, s];
        },
        reflectX: function (n) {
          return arguments.length
            ? ((h = no(a * (f = n ? -1 : 1), a * l, c, s)), t())
            : f < 0;
        },
        reflectY: function (n) {
          return arguments.length
            ? ((h = no(a * f, a * (l = n ? -1 : 1), c, s)), t())
            : l < 0;
        },
    ...
    (t.pack = function () {
      function t(t) {
        return (
          ...
          (t.y = r / 2),
          n
            ? t.eachBefore(zo(n)).eachAfter(Po(i, 0.5)).eachBefore(Ro(1))
            : t
                .eachBefore(zo(Co))
                .eachAfter(Po(Eo, 1))
                .eachAfter(Po(i, t.r / Math.min(e, r)))
                .eachBefore(Ro(Math.min(e, r) / (2 * t.r))),
          t
        );
      }
      var n = null,
        ...
        t.parent.A = (function (t, n, e) {
          if (n) {
            for (
              ...
              (c = Fo(c)),
                ((u = Io(u)).a = t),
                (r = a.z + l - o.z - s + i(a._, o._)) > 0 &&
                  (Yo(Bo(a, t, e), t, r), (s += r), (f += r)),
                (l += a.m),
                (s += o.m),
                (h += c.m),
                (f += u.m);
    ...
    (t.treemap = function () {
      ...
      return (
        ...
        (t.paddingTop = function (n) {
          return arguments.length
            ? ((c = "function" == typeof n ? n : Ao(+n)), t)
            : c;
        }),
        (t.paddingRight = function (n) {
          return arguments.length
            ? ((s = "function" == typeof n ? n : Ao(+n)), t)
            : s;
        }),
        (t.paddingBottom = function (n) {
          return arguments.length
            ? ((f = "function" == typeof n ? n : Ao(+n)), t)
            : f;
        }),
        (t.paddingLeft = function (n) {
          return arguments.length
            ? ((l = "function" == typeof n ? n : Ao(+n)), t)
            : l;
        }),
        t
      );
    ...
    (t.scaleSqrt = function () {
      return ku().exponent(0.5);
    }),
    (t.scaleQuantile = Su),
    (t.scaleQuantize = Eu),
    (t.scaleThreshold = Au),
    (t.scaleTime = function () {
      return Va(Gv, Wv, Lv, Pv, Cv, Ev, kv, wv, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2),
      ]);
    }),
    (t.scaleUtc = function () {
      return Va(xg, yg, ig, eg, tg, Jv, kv, wv, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2),
      ]);
    }),
    ...
    (t.arc = function () {
        ...
        if ((c || (c = t = ee()), l < f && ((s = l), (l = f), (f = s)), l > e_))
          if (d > o_ - e_)
            c.moveTo(l * Qg(h), l * t_(h)),
              c.arc(0, 0, l, h, p, !v),
              f > e_ &&
                (c.moveTo(f * Qg(p), f * t_(p)), c.arc(0, 0, f, p, h, v));
          else {
            var g,
              _,
              y = h,
                  ...
                  E < k
                    ...
                    : (c.arc(
                      ...
                      c.arc(
                        ...
                        0,
                        l,
                        Gg(g.cy + g.y11, g.cx + g.x11),
                        Gg(_.cy + _.y11, _.cx + _.x11),
                        !v
                      ),
                      c.arc(
                        _.cx,
      ...
      return (
        ...
        (t.padRadius = function (n) {
          return arguments.length
            ? ((i = null == n ? null : "function" == typeof n ? n : Ga(+n)), t)
            : i;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : Ga(+n)), t)
            : o;
        }),
        (t.endAngle = function (n) {
          return arguments.length
    ...
    (t.stack = function () {
      ...
      return (
        (t.keys = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : Ga(a_.call(e))), t)
            : n;
        }),
        (t.value = function (n) {
          return arguments.length
        ...
        (t.order = function (n) {
          return arguments.length
            ? ((e =
                null == n ? Gc : "function" == typeof n ? n : Ga(a_.call(n))),
              t)
            : e;
        }),
        (t.offset = function (n) {
    ...
    (t.voronoi = function () {
      function t(t) {
        return new Ns(
          t.map(function (r, i) {
            var o = [
              Math.round(n(r, i, t) / F_) * F_,
              Math.round(e(r, i, t) / F_) * F_,
            ];
      ...
      return (
        ...
        (t.x = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : ts(+e)), t)
            : n;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : ts(+n)), t)
            : e;
        }),
        (t.extent = function (n) {
          return arguments.length
    ...
    (t.zoom = function () {
      ...
      function e(t, n) {
        return (n = Math.max(b[0], Math.min(b[1], n))) === t.k
          ? t
          : new Ss(n, t.x, t.y);
      }
      function r(t, n, e) {
      ...
      function c() {
        if (g.apply(this, arguments)) {
          var t = u(this, arguments),
            ...
            i = Math.max(
              b[0],
              Math.min(b[1], n.k * Math.pow(2, m.apply(this, arguments)))
            ),
            o = pt(this);
          if (t.wheel)
      ...
      function f() {
        if (g.apply(this, arguments)) {
          ...
          Cs(),
            M > 0
              ? ct(this).transition().duration(M).call(o, s, u)
              : ct(this).call(n.transform, s);
        }
      }
      function l() {
        if (g.apply(this, arguments)) {
      ...
      function h() {
        ...
        for (Cs(), d && (d = clearTimeout(d)), n = 0; n < f; ++n)
          (o = dt(this, s, (i = s[n]).identifier)),
            c.touch0 && c.touch0[2] === i.identifier
              ? (c.touch0[0] = o)
              : c.touch1 && c.touch1[2] === i.identifier && (c.touch1[0] = o);
      ...
      return (
        ...
        (n.wheelDelta = function (t) {
          return arguments.length
            ? ((m = "function" == typeof t ? t : ks(+t)), n)
            : m;
        }),
        (n.filter = function (t) {
          return arguments.length
            ? ((g = "function" == typeof t ? t : ks(!!t)), n)
            : g;
        }),
        (n.touchable = function (t) {
          return arguments.length
            ? ((x = "function" == typeof t ? t : ks(!!t)), n)
            : x;
        }),
        (n.extent = function (t) {
          return arguments.length
